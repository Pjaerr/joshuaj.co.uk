...
image: "/building-desktop-app-svelte-electron/cover_image.jpg?123"
---
...
![Diagram showing the flow between renderer and main](/building-desktop-app-svelte-electron/renderer-main-data-flow)
